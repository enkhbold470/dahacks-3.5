    ...
    <section id="team" className="py-20 relative bg-cyber-light/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-cyber font-bold mb-4 neon-text-purple animate-glow">
            MEET THE TEAM
          </h2>
          ...
          {hackathonData.team.map((member, index) => (
            ...
            >
              ...
              <div className="text-center relative z-10">
                ...
                <h3 className="text-xl font-cyber font-bold mb-1 text-neon-purple">{member.name}</h3>
