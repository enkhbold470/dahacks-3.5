        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex space-x-4 justify-center md:justify-start">
              ...
              <a href={`${hackathonData.contact.instagram}`} target="_blank" rel="noopener noreferrer"
              ...
              <a href={`${hackathonData.contact.discord}`} target="_blank" rel="noopener noreferrer"
